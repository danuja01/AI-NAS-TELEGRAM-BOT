...
TELEGRAM_BOT_COMMANDS = [
    ...
    BotCommand("orchestrator", "Resource orchestrator status"),
    BotCommand("mitigate_now", "Free RAM/CPU (admin)"),
    BotCommand("restore_now", "Restore paused/stopped (admin)"),
...
def main():
    ...
    application.add_handler(
        CallbackQueryHandler(
            ...
            pattern=r"^(uackall|uack|usil|ulog|urst|uai):",
        ),
        group=-1,
    )
