...
from services.readonly import ALL_READONLY_PROFILE_NAMES, build_readonly_inner
...
def validate_readonly_scan_path(path: str) -> bool:
    ...
    from services.readonly import validators as ro_v

    return ro_v.validate_scan_path(path)
...
def validate_readonly_systemd_unit(unit: str) -> bool:
    ...
    return ro_v.validate_systemd_unit(unit)
